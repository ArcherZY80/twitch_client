package com.ysdemo.demo.controller;

import com.ysdemo.demo.entity.db.Item;
import com.ysdemo.demo.entity.request.FavoriteRequestBody;
import com.ysdemo.demo.service.FavoriteService;
...
public class FavoriteController {
    ...
    public void setFavoriteItem(@RequestBody FavoriteRequestBody requestBody, HttpServletRequest request, HttpServletResponse response) {
        // false represents will not create session if not found one
